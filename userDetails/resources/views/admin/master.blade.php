...
<script src="{{ asset('/') }}front-assets/assets/demo/chart-area-demo.js"></script>
<script src="{{ asset('/') }}front-assets/assets/demo/chart-bar-demo.js"></script>
<script src="https://cdn.jsdelivr.net/npm/simple-datatables@latest" crossorigin="anonymous"></script>
<script src="{{ asset('/') }}front-assets/js/datatables-simple-demo.js"></script>
</body>
</html>
